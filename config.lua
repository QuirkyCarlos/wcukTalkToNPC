...
Config.UsewcukTextUI = true -- If true it'll use wcukTextUI 
...
Config.TalkToNPC = {
	{
		...
		options = {													-- Options shown when interacting (Maximum 6 options per NPC)
			{'Where is the toilet?', 'wcukTalk:toilet', 'c'},		-- 'c' for client
			{'How can I rob the bank?', 'wcukTalk:rob', 'c'},		-- 's' for server (if you write something else it'll be server by default)
			{"I want to access my safe.", 'wcukTalk:safe', 'c'}, 
			{"I want to make a new credit card.", 'wcukTalk:card', 'c'}, 
			{"I lost my credit card.", 'wcukTalk:lost', 'c'}, 
			{"Is Jennifer working?", 'wcukTalk:jennifer', 'c'}, 
		},
